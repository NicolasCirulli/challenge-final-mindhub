    ...
    <div className="container">
        ...
        <div className="container cont-welcome">
          <div className="welcome">
            <div className="text-welcome">
              <Typography variant="h2" component="div" className="welcome2">
                Welcome to Xtreme
              </Typography>
              <Typography
                variant="h6"
                ...
                className="subtitle"
              >
                We are the best place to play, talk about games, and create
                games.
              </Typography>
            </div>
      ...
      <div className="container access-game">
        ...
        <Typography variant="h5" component="div" className="welcome4">
          Large number of published games; from large companies to independent
          studios and everything in between. Enjoy exclusive offers, automatic
          updates and other great benefits.
        </Typography>
