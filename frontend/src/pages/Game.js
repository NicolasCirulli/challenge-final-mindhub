        ...
        <>
            <div className="gamebg ">
                <div className="container">
                    <h1 className="gamePath">
                        STORE/*Categoria*/*nombre del juego*
                    </h1>
            ...
            <div className="container descriptions">
                <div className="text">
                    ...
                    <p className="game-desc">
                        ...
                        Cras pharetra congue metus, sed egestas mi. Suspendisse
                        at enim ultrices, fringilla tortor eu, consequat arcu.
                        Proin elementum libero sit amet eros pellentesque, a
                        consequat leo suscipit. Maecenas vel condimentum ipsum.
                        Nam a euismod risus. Nam eleifend pretium odio, eget
                        consequat ex molestie id. Aenean convallis sed massa a
                        interdum. Curabitur et tellus feugiat, mattis turpis ac,
                        vulputate dui. Integer efficitur, sapien ac mattis
                        fringilla, diam orci cursus est, eu lacinia eros mi vel
                        turpis. Maecenas non lacinia ante, et elementum mauris.
                        Cras non nisl feugiat felis imperdiet aliquam eu non
                        est.
                    </p>
                </div>
