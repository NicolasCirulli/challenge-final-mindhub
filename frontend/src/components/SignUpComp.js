                    ...
                    <form>
                        <div className='bodyFormSU'>
                            <div className='onlyInputs'>
                                <div className='namesSU'>
                                    ...
                                    <div className='inputLastame'>
                                        ...
                                        <input type="text" id="lastname" className='labelSU' ref={userName}/>
                                    </div>
                                </div>
                                ...
                                <div className='adicionalInfo'>
                                    ...
                                    <div className='inputCountry'>
                                        <label>Country</label>
                                        <select type="text" id="country" className='labelSU' onChange={handleCountry}>
                            ...
                            <div className='buttonsSignUp'>
                                <input type="button" className='linkSignIn' value="Sign up" onClick={newUser} />
                            </div>
                        </div>
                    </form>
                </div>
