        ...
        <div className="backgroundSignIn">
            <div className="cardSign">
                ...
                >
                    ...
                    <h1>Hello!</h1>
                    <p>Welcome again to our site. We have so many captivating games for
                 you. Just sign up and visit our game store with different selections. And don't forget to share your
                 opinions with!
                    </p>
                    </div>
                </div>
